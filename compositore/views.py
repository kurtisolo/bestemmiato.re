...
def bestemmia(tipo_insulto, form, complessita):
    ...
    if complessita == "semplice":
        ...
        insulto = random.choice(
            [
                i
                for i in tipo_insulto
                if i != insulto2 and i != insulto3 and i != insulto4
            ]
        )
        insulto2 = random.choice(
            [
                i
                for i in tipo_insulto
                if i != insulto and i != insulto3 and i != insulto4
            ]
        )
        insulto3 = random.choice(
            [
                i
                for i in tipo_insulto
                if i != insulto and i != insulto2 and i != insulto4
            ]
        )
        insulto4 = random.choice(
            [
                i
                for i in tipo_insulto
                if i != insulto and i != insulto2 and i != insulto3
            ]
        )
    ...
    def delete_previous_audio_files(directory, current_file_name):
        for filename in os.listdir(directory):
            if (
                ...
                and filename.startswith("audio_")
